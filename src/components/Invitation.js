                ...
                <div className="row">
                    ...
                    <div className="col-sm-10">
                        <div className="heading">
                            <p>В ден благословен съдбата нас събра и животът ни изпълни се от Любовта. С криле дарени, за да полетим решихме остатъка от дните си да споделим. Към нашият празник се присъединете, денят ни сватбен уважете и нашата покана приемете!</p>
                        </div>
